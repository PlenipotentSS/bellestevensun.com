...
function sparkling_scripts() {
  ...
  // SS ADD CUSTOMIZATION
  wp_enqueue_script( 'ss-custom-script', get_template_directory_uri() . '/assets/js/dist.js', array('jquery')  );
}
...
class BelleTimberSite extends TimberSite {
  ...
  function add_to_context( $context ) {
    // $context['analytics_id'] = of_get_option('analytics_id');
    // $context['contact_phone'] = of_get_option('contact_phone');
    // $context['contact_phone_formatted'] = of_get_option('contact_phone');
    // $context['contact_fax'] = of_get_option('contact_fax');
    // $context['contact_fax_formatted'] = of_get_option('contact_fax');
    // $context['contact_email'] = of_get_option('contact_email');
    // $context['header_contact_phone'] = of_get_option('header_contact_phone');
    
    // $context['twitter_url'] = of_get_option('twitter_url');
    // $context['facebook_url'] = of_get_option('facebook_url');
    // $context['vimeo_url'] = of_get_option('vimeo_url');
    // $context['youtube_url'] = of_get_option('youtube_url');
    // $context['gplus_url'] = of_get_option('gplus_url');
    // $context['instagram_url'] = of_get_option('instagram_url');
    // $context['linkedin_url'] = of_get_option('linkedin_url');
    // $context['pinterest_url'] = of_get_option('pinterest_url');
    // $context['github_url'] = of_get_option('github_url');

    // $context['default_image_hero'] = of_get_option('default_image_hero');
    // $context['default_image_staff_hero'] = of_get_option('default_image_staff_hero');
    // $context['default_image_advisors_hero'] = of_get_option('default_image_advisors_hero');
    // $context['default_image_services_hero'] = of_get_option('default_image_services_hero');
    // $context['default_image_post_thumbnail'] = of_get_option('default_image_post_thumbnail');

    // $context['copy_advisors_header'] = of_get_option('copy_advisors_header');
    // $context['copy_advisors_subheader'] = of_get_option('copy_advisors_subheader');
    // $context['copy_staff_header'] = of_get_option('copy_staff_header');
    // $context['copy_staff_subheader'] = of_get_option('copy_staff_subheader');
    // $context['copy_resources_featured'] = of_get_option('copy_resources_featured');
    // $context['copy_services_header'] = of_get_option('copy_services_header');
    // $context['copy_services_header_page'] = of_get_option('copy_services_header_page');
    // $context['copy_services_header_content'] = of_get_option('copy_services_header_content');
    // $context['copy_footer_posts_header'] = of_get_option('copy_footer_posts_header');
    // $context['copy_footer_posts_subheader'] = of_get_option('copy_footer_posts_subheader');

    // $context['copy_block_1_header'] = of_get_option('copy_block_1_header');
    // $context['copy_block_1_icon'] = of_get_option('copy_block_1_icon');
    // $context['copy_block_1_description'] = of_get_option('copy_block_1_description');
    // $context['copy_block_1_link'] = of_get_option('copy_block_1_link');

    // $context['copy_block_2_header'] = of_get_option('copy_block_2_header');
    // $context['copy_block_2_icon'] = of_get_option('copy_block_2_icon');
    // $context['copy_block_2_description'] = of_get_option('copy_block_2_description');
    // $context['copy_block_2_link'] = of_get_option('copy_block_2_link');

    // $context['copy_block_3_header'] = of_get_option('copy_block_3_header');
    // $context['copy_block_3_icon'] = of_get_option('copy_block_3_icon');
    // $context['copy_block_3_description'] = of_get_option('copy_block_3_description');
    // $context['copy_block_3_link'] = of_get_option('copy_block_3_link');

    // $context['copy_block_4_header'] = of_get_option('copy_block_4_header');
    // $context['copy_block_4_icon'] = of_get_option('copy_block_4_icon');
    // $context['copy_block_4_description'] = of_get_option('copy_block_4_description');
    // $context['copy_block_4_link'] = of_get_option('copy_block_4_link');
    
    // $context['copy_block_sa_header'] = of_get_option('copy_block_sa_header');
    // $context['copy_block_sa_icon'] = of_get_option('copy_block_sa_icon');
    // $context['copy_block_sa_description'] = of_get_option('copy_block_sa_description');
    // $context['copy_block_sa_link'] = of_get_option('copy_block_sa_link');

    // $context['copy_block_ca_header'] = of_get_option('copy_block_ca_header');
    // $context['copy_block_ca_icon'] = of_get_option('copy_block_ca_icon');
    // $context['copy_block_ca_description'] = of_get_option('copy_block_ca_description');
    // $context['copy_block_ca_link'] = of_get_option('copy_block_ca_link');
