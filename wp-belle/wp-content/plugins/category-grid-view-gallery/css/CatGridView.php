 ...
 */
 ...
 class CatGridView{
	...
	private function cg_get_image($single){
		...
		return '<a href='.$returnlink.'><img src="http://www.killerdillerweekend.com/wp-belle'.str_replace(get_option('siteurl'), '', $cg_img).'" width="'.$size[0].'" height="'.$size[1].'" alt="'.$single->post_title.'" title="'.$single->post_title.'"/></a>';
